...
export function SwapIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7 10V5m0 0L4 8m3-3 3 3" />
      <path d="M17 14v5m0 0 3-3m-3 3-3-3" />
    </svg>
  );
}
...
export function StreetcarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <rect x="3" y="6" width="18" height="11" rx="2.5" />
      <path d="M3 12h18" />
